...
@Component({
  selector: 'app-mensajeria-vendedor-form',
  templateUrl: './mensajeria-vendedor-form.component.html',
  styleUrls: ['./mensajeria-vendedor-form.component.css']
})
export class MensajeriaVendedorFormComponent {
  ...
  //Verificar si se envio un id por parametro para crear formulario para actualizar
    this.activeRouter.params.subscribe((params:Params)=>{
      ...
      // if (this.currentUser.user.detalle_usuarioTipo[1].id_tipoUsuario===3) {
   ...
   if(this.isCreate){
    ...
    this.router.navigate(['/mensajeria-vendedor/all'],{
    ...
    actualizarMensaje() {
      ...
      // } else {
        ...
        if (this.currentUser.user.detalle_usuarioTipo[1].id_tipoUsuario===3&&!this.tieneRespuesta) {
